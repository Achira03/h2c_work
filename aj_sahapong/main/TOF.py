...
if __name__ == '__main__':
    ...
    filename = datetime.now().strftime("abnormal_tof_50.csv")
    ...
    def tof_data_handler(sub_info):
        ...
        if recording_active.is_set():
            ...
            print(f"Recorded ToF: {timestamp}, tof1={tof_values[0]}, tof2={tof_values[1]}, tof3={tof_values[2]}, tof4={tof_values[3]}")
